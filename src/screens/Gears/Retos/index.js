...
import { View, TextInput, TouchableOpacity, Text, Keyboard, TouchableWithoutFeedback, Share } from "react-native";
...
const DentesRetos = () => {
  ...
  const Calcular = () => {
    const resultadosCalculoPromise = Calculos(modulo1, numeroDentes1, modulo2, numeroDentes2);;
